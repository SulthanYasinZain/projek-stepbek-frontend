...
export default function Alumni() {
  ...
  return (
    <section className="flex flex-col gap-4">
      <h1 className="text-center text-foreground text-xl sm:text-4xl font-medium">
        What Professionals Are Saying About Their Experience with Skillo
      </h1>
      <div className="relative -z-10 flex flex-col px-6 sm:px-0 sm:flex-row gap-4 items-center justify-center mt-12">
        {testimonials.map((testimonial, index) => (
          <MagicCard
            key={index}
            className="w-full max-w-[350px] h-auto sm:h-[300px] rounded-md bg-transparent p-8"
            gradientOpacity={0}
            gradientFrom="#2ECC71"
            gradientTo="#74d4f4"
          >
            <div className="flex flex-col">
              <div className="flex gap-2 items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <h2 className="text-neutral-500">{testimonial.occupation}</h2>
                </div>
              </div>
